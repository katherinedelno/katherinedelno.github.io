...
<style>
  ...
  .pg{--ink:#1f1f1f;--muted:#5c5c5c;--line:#e6e6e6;--accent:#2b2b2b;--card:#fbfbfb;color:var(--ink);line-height:1.6}
  ...
  .pol-jump{display:flex;gap:8px 22px;flex-wrap:wrap;margin:1.6rem 0 .2rem}
  .pol-jump a{font-size:.76rem;font-weight:700;letter-spacing:.11em;text-transform:uppercase;color:var(--muted);text-decoration:none}
  .pol-jump a:hover{color:var(--ink)}
  .pol-jump a:focus-visible{outline:2px solid var(--accent);outline-offset:3px;color:var(--ink)}

  .pol-section{padding:2.4rem 0 1.6rem;border-top:1px solid var(--line);margin-top:1.2rem;scroll-margin-top:24px}
  .pol-section:first-of-type{margin-top:1.6rem}
  .pol-section h2{font-size:1.35rem;font-weight:700;letter-spacing:-.015em;margin:0 0 .9rem}
  .pol-section h3{font-size:1.06rem;margin:2.2rem 0 .6rem}
  .pol-section p{margin:0 0 1rem}
  ...
  .pol-fine{margin-top:2.4rem;padding-top:1.4rem;border-top:1px solid var(--line);color:var(--muted);font-size:.92rem}
  .pol-fine p{max-width:74ch}
...
<div class="pg" markdown="0">
  ...
  <!-- BILLING -->
  <div class="pol-section" id="billing">
  ...
  <div class="pol-section" id="referrals">
    ...
    <h2>Referrals</h2>
    <p>If you refer a family and their student enrolls, I credit one 90-minute session, $180, to your next invoice once the new student has completed a first month of instruction. There is no limit, and the credit applies whether or not you are enrolled at the time.</p>
