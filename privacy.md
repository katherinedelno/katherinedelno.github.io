...
<style>
  ...
  .pol-section h2{font-size:1.24rem;font-weight:700;letter-spacing:-.015em;margin:0 0 .9rem}
  .pol-section p{margin:0 0 1rem;font-size:.99rem}
  ...
  .pol-fine p{max-width:74ch;margin:0 0 .4rem}
